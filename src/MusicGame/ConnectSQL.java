...
public class ConnectSQL {
	...
	private String connectionString = "jdbc:sqlserver://musicgame.database.windows.net:1433;"
			+ "database=MusicGame;"
	...
	public int add(String name, String time, String challenge)
			throws SQLException {

		return statement.executeUpdate("INSERT INTO ChallengeStore VALUES ('"
				+ name + "','" + time + "','" + challenge + "')");
